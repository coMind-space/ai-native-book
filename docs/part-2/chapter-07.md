...
Правильная модель другая: ассистент должен обращаться к живым источникам вместо статичного описания компании.
...
Плохая модель звучит так: «Подключим ассистента ко всем документам, чтобы он лучше отвечал».
...
Правильный слой обезличивания должен находиться до передачи данных в модель. Иначе получается странная ситуация: сырые персональные или конфиденциальные данные уже ушли в LLM, а потом мы просим ее «обезличить результат».
...
Ассистент должен давать ответ и показывать, когда источники расходятся: «В источниках есть противоречие. В CRM указан один срок, в протоколе встречи другой. По правилу приоритета главным считаю протокол встречи, но требуется подтверждение владельца проекта».
