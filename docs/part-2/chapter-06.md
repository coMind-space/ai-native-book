...
Если компания хочет получить от ИИ системный эффект, ей нужно собирать не коллекцию промптов, а библиотеку skills: с владельцами, source of truth, правилами качества, ограничениями, примерами и проверкой.
