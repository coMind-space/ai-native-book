...
Наивный промпт: «Сделай счет для клиента».
...
- Название: подготовка черновика счета.
- Для кого: финансовый менеджер, аккаунт-менеджер.
- Задача: подготовить черновик счета на оплату по согласованным данным.
...
Такой skill помогает финансовому менеджеру убрать ручную подготовку и снизить риск пропущенных полей.

## Пример: skill для протокола встречи

Другой частый сценарий — протокол встречи.

Наивный промпт: «Сделай summary встречи».

На выходе получится текст, но не обязательно управленческий артефакт.

Skill должен задавать структуру.

- Название: протокол встречи и контроль договоренностей.
- Для кого: руководитель проекта, продавец, аккаунт-менеджер, руководитель отдела.
- Задача: превратить запись или заметки встречи в управляемый протокол.
...
Если внутри только просьба к модели и желаемый тон ответа, перед нами промпт в красивой упаковке.
...
Если он помогает автору и другим сотрудникам, вы начали превращать личное мастерство в актив компании.
