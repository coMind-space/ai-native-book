...
![Операционная формула AI-Native контура](/img/illustrations/chapter-04-operating-model.png)
...
Skill — это рабочий навык ассистента: описанный способ выполнения задачи, входы, источники, ограничения, порядок работы, формат результата и проверка качества.

Source of truth — источник правды. Это место, откуда ассистент и человек берут актуальные факты: документ, база знаний, CRM, система задач, хранилище договоров, репозиторий, учетная система или другой официальный источник.
...
2. Описывать входы. Ассистент должен понимать, какие

данные нужны для работы.

3. Указывать source of truth. Если нет источника правды,

ассистент будет гадать.

4. Фиксировать ограничения. Что нельзя обещать, читать,

менять, отправлять или утверждать.

5. Задавать правила качества. Как понять, что результат

хороший.

6. Определять границу человека. Где ассистент готовит, где

проверяет, а где обязан остановиться.

7. Сохранять результат и уроки. После выполнения задачи
...
Например, вместо общего «улучшить продажи» выберите «ускорить подготовку менеджера к первой встрече по входящему запросу».

Вместо «автоматизировать документы» выберите «готовить черновик счета и акта по согласованным данным с проверкой реквизитов и суммы».

Вместо «помочь разработке» выберите «проводить задачу от описания до запроса на внесение изменений с тестами и проверкой».
