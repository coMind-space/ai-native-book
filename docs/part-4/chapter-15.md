...
В зрелой компании библиотека skills должна храниться в управляемом Git-репозитории. Это не потому, что каждый сотрудник должен стать разработчиком. А потому, что skill — это корпоративный актив с историей изменений, владельцем, review, версиями и контролем качества.
