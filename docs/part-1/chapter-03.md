...
![Сдвиг мышления: от старого способа работы к новому](/img/illustrations/chapter-03-mindshift.png)
...
Его ценность не в том, что он быстрее нажимает кнопки. Его ценность в том, что он умеет превращать неясное требование в проверяемую задачу, управлять ассистентом, оценивать результат и улучшать рабочий skill команды.
