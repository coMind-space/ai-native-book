...
Человек действительно тратит больше времени, потому что еще не умеет работать с ассистентом. Он пытается встроить ИИ в старую привычку вместо пересмотра способа выполнения задачи.
...
С этого момента ИИ начинает работать как расширение рабочего мышления.
...
ИИ начинает подсвечивать свои ограничения и беспорядок в работе компании.
...
Трудности сотрудника в работе с ассистентом могут показывать, что компания впервые увидела неоформленное рабочее знание.
...
Руководитель должен понимать: сопротивление часто возникает из-за угрозы статусу.

Сильному человеку нужно показать новую роль: «теперь ты можешь владеть более сложным контуром».

Для программиста новая роль — AI-Native инженер: он проектирует задачу, управляет ассистентом, проверяет архитектуру, отвечает за качество, собирает skills и ускоряет весь цикл разработки.

Продавец в новой роли владеет коммерческим контуром: лучше помнит клиента, быстрее готовится, видит риски сделки, не теряет следующий шаг.

Руководитель проекта начинает видеть систему проекта шире: зависимости, риски, решения, статусы и пробелы в коммуникации.

ИИ переносит профессиональную гордость на новый уровень, когда человек владеет более сложным контуром.
...
До сдвига ассистент воспринимается как отдельный инструмент. После сдвига он становится частью мышления.
...
В AI-Native контуре руководителю нужно задавать вопросы об итоговой задаче и способе работы:
...
Так выглядит новая управленческая грамотность.
...
AI-Native руководитель управляет людьми, задачами и качеством связки между человеком и ассистентом.
...
Фраза «ИИ вас не заменит» звучит успокаивающе и скрывает неприятную часть изменений. Часть задач действительно исчезнет. Часть ролей изменится до неузнаваемости. Некоторые сотрудники, которые не захотят подниматься на новый уровень ответственности, станут менее ценными.

Лучше говорить честнее: ИИ заберет часть старой работы и создаст новую зону ответственности для тех, кто готов владеть более сложным контуром.
...
Вместо вопроса «Как вы хотите использовать ИИ?» задайте более конкретные вопросы:
