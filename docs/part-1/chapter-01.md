...
- стало ли качество результата стабильнее для всей команды.
...
Сильный сотрудник быстро находит способ использовать ИИ: пишет лучше, анализирует быстрее и готовит материалы аккуратнее. Но его способ работы остается личным.

Такой сотрудник знает, как сформулировать запрос, какие документы можно прикрепить, где модель обычно ошибается и как проверить ответ.
...
Обучение промптам полезно: оно помогает людям начать, снижает страх перед ИИ и показывает, как качество ответа зависит от качества постановки задачи.
...
Поэтому промпт должен стать частью skill, где есть контекст, источники, ограничения и проверка качества.

Skill — это рабочий протокол. В нем описано, какую задачу решаем, какие входы принимаем, где искать факты, как проверять результат, что нельзя делать и какой итог должен получить человек.

Промпт помогает ассистенту говорить. Skill помогает компании работать.

## Руководитель часто видит активность вместо эффекта

Самая опасная ловушка — перепутать использование с результатом.

Можно измерять активность: сколько людей открыли ассистента, сколько запросов отправили, сколько документов сгенерировали и сколько встреч пересказали.
...
- насколько стабильно разные сотрудники получают хороший результат.
...
В первую неделю выберите один рабочий контур, где результат можно увидеть быстро. На старте отложите:

- выбор модели;
- закупку подписок на всю компанию;
- большой список процессов.
...
Важно не путать рабочий контур с полной интеграцией всех систем. На первом шаге достаточно типовых документов и понятных источников: счет, счет-фактура, акт, коммерческое предложение, договор, протокол встречи, заявка клиента, тендерная документация. Именно на таких материалах проще всего показать, что ассистент помогает роли выполнять работу быстрее и надежнее.

## Вопросы для руководителя

- Где в компании уже есть люди, которые используют ИИ лучше остальных?
- Их практика описана как skill или живет только в их голове?
- Какие процессы чаще всего тормозят из-за поиска информации, подготовки документов или потери контекста?
...
ИИ начинает менять компанию, когда вокруг него появляется рабочий контур: роль, задача, source of truth, skill, проверка качества и ответственность человека.
