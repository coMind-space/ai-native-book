...
Большая языковая модель не похожа на обычную программу. Она не просто хранит данные, не просто показывает таблицу, не просто отправляет сообщение и не просто автоматизирует одну кнопку. Она работает с языком, контекстом, документами, кодом, задачами и решениями. Она может объяснять, искать связи, готовить черновики, сравнивать варианты, писать инструкции, находить ошибки и предлагать следующий шаг.
...
Во всех этих примерах ИИ не является “умной вкладкой рядом”. Он занимает место внутри процесса. У него есть вход, выход, правила и точка передачи человеку.
...
Если вы ответили на эти вопросы, вы начали проектировать не инструмент, а новый способ работы.
