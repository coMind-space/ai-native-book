...
![Граница MCP между агентами и корпоративными системами](/img/illustrations/chapter-08-architecture.png)
...
сотрудник ↓ единый интерфейс ассистента ↓ слой ассистентов и агентов ↓ skills ↓ MCP-шлюз
