...
> Ассистент должен получать только те данные и действия, которые нужны человеку для конкретной задачи. Не больше.
...
Хороший аудит отвечает на вопрос: можем ли мы понять, что произошло, не создавая новую утечку в самих логах?
